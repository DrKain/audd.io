...
var Audd = /** @class */ (function () {
    function Audd(api_token) {
        ...
        this.api_token = '';
        this.debug = false;
        this.uri_recognize = 'https://api.audd.io';
        this.uri_withoffset = 'https://api.audd.io/recognizeWithOffset';
        if (api_token)
    ...
    Audd.prototype.recognizeWithOffset = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            fetch(url, data).then(function (d) { return d.json(); }).then(function (response) {
    ...
    Audd.prototype.guessFromFile = function (file, extra) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            form.append('file', stream, { knownLength: size });
            form.append('api_token', _this.api_token);
            _this.recognizeWithOffset({ body: form, method: 'POST' }).then(resolve, reject);
        });
    };
    /**
